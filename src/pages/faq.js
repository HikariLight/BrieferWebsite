  ...
  return (
    <Layout>
        ...
        <section className="QnA">
          <Qa question="Who created this project?" answer = "We're a team of 2 developers. You can find us on Github!"></Qa>
          <ul>
            <li><a href='https://github.com/HikariLight'>HikariLight</a></li>
            <li><a href='https://github.com/Rahuz7'>Rahuz</a></li>
          </ul>
          <Qa question="Will any of my personal data be collected?" answer="Nope! Briefer is designed to run completely locally. We do not collect any userdata."></Qa>
